  ...
  return (
    <div className="my-28 w-11/12 mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        >
          <h2 data-aos="fade-up" data-aos-duration="1000" className="font-p text-2xl md:text-4xl w-full lg:w-8/12 mb-4">
          ...
          <form data-aos="fade-zoom-in"
              ...
              data-aos-offset="0" className="grid grid-cols-1 md:grid-cols-2 gap-4 font-o">
            <div>
