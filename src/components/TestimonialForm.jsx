  ...
  return (
    <div className="my-28 w-11/12 mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        >
          <h2 className="font-p text-2xl md:text-4xl w-full lg:w-8/12 mb-4">
            We'd love to hear from you!
          </h2>

          <form className="grid grid-cols-1 md:grid-cols-2 gap-4 font-o">
            <div className="">
              ...
              <input
                type="text"
                name="firstName"
                className="w-full rounded p-3 bg-white outline-[#3CA200] border border-white hover:border hover:border-[#3CA200]"
                placeholder="John"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <select
                ...
                className="rounded-md p-3 bg-white w-full outline-[#3CA200] border border-white hover:border hover:border-[#3CA200]"
              >
