...
const HowItWork = () => {
    return (
        <div className="my-20 w-11/12 mx-auto space-y-10 font-p">
            ...
            {/* text */}
            <div className="text-center font-p space-y-3">
                <h3>HOW IT WORKS</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5 gap-y-28">
                ...
                <div className="flex flex-col items-center space-y-3 text-center">
                    ...
                    <h3 className="text-lg lg:text-2xl">Enjoy Hassle-Free Service</h3>
                    <p className="text-gray-600">Sit back and relax while our professionals take care of everything.</p>
                </div>
            </div>
        </div>
    );
