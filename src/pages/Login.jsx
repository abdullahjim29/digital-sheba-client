  ...
  return (
    <div className="my-10">
      <div className="flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-base-100  dark:text-gray-800">
          ...
          <div className="my-6 space-y-4">
            <button
              ...
              type="button"
              className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600 cursor-poi"
            >
              <svg
